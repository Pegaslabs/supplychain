 ...
 *
 * <pre>
 *   InventoryAppDev = angular.module('InventoryAppDev', ['InventoryApp', 'ngMockE2E']);
 *   InventoryAppDev.run(function($httpBackend) {
...
(window.jasmine || window.mocha) && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('InventoryApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('InventoryApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('InventoryApplicationModule'));
   *
   *
