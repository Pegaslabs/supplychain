 ...
 *
 * <pre>
 *   SupplyChainAppDev = angular.module('SupplyChainAppDev', ['SupplyChainApp', 'ngMockE2E']);
 *   SupplyChainAppDev.run(function($httpBackend) {
...
(window.jasmine || window.mocha) && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('SupplyChainApplicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('SupplyChainApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('SupplyChainApplicationModule'));
   *
   *
