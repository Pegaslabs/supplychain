 ...
 * SupplyChainApp.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://SupplyChainApp.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://SupplyChainApp.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('SupplyChainApp', []).config(function($sceDelegateProvider) {
 ...
 *        'http://SupplyChainApp.example.com/clickThru**']);
 *      });
 * </pre>
 */
 ...
 * @example
 <example module="mySceApp">
  <file name="index.html">
    <div ng-controller="SupplyChainAppController as myCtrl">
  ...
  <file name="script.js">
    ...
    mySceApp.controller("SupplyChainAppController", function SupplyChainAppController($http, $templateCache, $sce) {
      var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('SupplyChainAppWithSceDisabledSupplyChainApp', []).config(function($sceProvider) {
