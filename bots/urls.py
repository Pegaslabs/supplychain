...
from inventory.api import UserResource,ItemCategoryResource,ItemResource,ItemAttributeResource,LocationResource,ShipmentResource,ItemLotResource,ItemLotAttributeResource,StockChangeResource,UserPreferencesResource,PatientResource,DistrictResource,SearchResource
...
v1_api.register(ItemAttributeResource())
